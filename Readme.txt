...
"DeleteStudentProfiles Script Version 2.4SE" is a batch file for a DOS GUI for the Delprof2 utility. It allows the DOS script to get a list of computer names to work on and provides some other minor features.

2.4 Added features:

* Added deletion of profiles that begin with the number "4". (This is specific to the school I work in, you ill have to change this to match the type of usernames that students use at the schools you support)
