...
* Added deletion of profiles that begin with the number "4".
* Added ablility to Run from School Server hence the "SE" at the end of the version number meaning Server Edition.
